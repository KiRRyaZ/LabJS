...
let fs = require('fs');
let science = require('./ScienceArray.js');


//---------------------------------------------------
function substringInArray(s, arr) {
  s = s.toLowerCase();
  return arr.filter(item => item.toLowerCase().includes(s));
}


//---------------------------------------------------
function stringsInText(t, arr) {
  t = t.toLowerCase();
  return arr.filter(item => t.includes(item.toLowerCase()));
}
...
//Задание #4
//Вариант 1
console.log('\nЗадание #4. Вариант #1. Массив кодов букв строки: \n');
...
//Вариант 2
console.log('\n\nЗадание #4. Вариант #2. Массив слов строк:\n');
...
console.log(
  '\n\nЗадание #5. Вариант #2. ' + 
  'Текст имеет эти слова из science: \n' + 
